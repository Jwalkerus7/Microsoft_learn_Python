"""first__string = 'A literal string'
second_string = "A literal string"
print(second_string == first__string)

third_string = 'A single quoted literal string witrh a " double quote'
...
#on more tha one line
#sometimes known as a verbatim string'''
#eleventh_string = """Anoither literal string
